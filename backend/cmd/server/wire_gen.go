...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	sessionManager := quotanetws.NewSessionManager(nodes.NewAuthenticator(entStore), quotaNetRegistry).WithSessionStore(entStore).WithTaskStore(quotaNetTaskStore)
