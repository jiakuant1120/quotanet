...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	quotaNetTaskStore := tasks.NewEntStore(client).WithContributionBilling(billingService, modelPricingResolver)
	...
	quotaNetSettlementHandler := admin.NewQuotaNetSettlementHandler(quotaNetSettlementStore, quotaNetRegistry)
