<template>
  ...
  <!-- QuotaNet logo (connected nodes) -->
  <svg v-else-if="platform === 'quotanet'" :class="sizeClass" viewBox="0 0 24 24" fill="none">
    <path
      d="M7 8.5L12 5l5 3.5M7 15.5l5 3.5 5-3.5M7 8.5v7M17 8.5v7M12 5v14"
      stroke="currentColor"
      stroke-width="2"
    ...
    />
    <path
      d="M7 10.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM17 10.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM12 21a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"
      fill="currentColor"
    />
  </svg>
