...
interface Props {
  ...
  overscan?: number
  /** Disable desktop virtual rows for short tables rendered in auto-height panels */
  virtualized?: boolean
}
...
const rowVirtualizer = useVirtualizer(computed(() => ({
  count: isDesktopViewport.value && props.virtualized ? (sortedData.value?.length ?? 0) : 0,
